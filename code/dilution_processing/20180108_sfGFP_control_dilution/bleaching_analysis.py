...
slide_files = glob.glob(
    '{0}/20180105_fluorescent_slide*/Pos*/*.tif'.format(root_dir))
...
popt = scipy.optimize.minimize(mscl.stats.log_posterior_biexp, guess, method='Powell',
